...
import * as appLayout from '@examples/layout-app-layout';
import { apply as applyGeneral, inject as generalInject } from '@examples/layout-settings-general';
import { apply as applySettingsLayout } from '@examples/layout-settings-layout';
