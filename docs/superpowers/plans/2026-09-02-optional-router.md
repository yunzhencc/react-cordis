...
- Modify: `examples/router/cordis.yml`
...
**Files:**
- Modify: `examples/router/plugins/dashboard/src/index.tsx`
- Modify: `examples/router/plugins/dashboard/src/index.test.tsx`
...
Run: `pnpm exec vitest run examples/router/plugins/dashboard/src/index.test.tsx`
...
Run: `pnpm exec vitest run packages/ui/layout/src/index.test.tsx packages/ui/router/src/index.test.tsx examples/router/plugins/dashboard/src/index.test.tsx packages/host/plugin-catalog/src/index.test.ts`
...
Run: `pnpm --filter @examples/router build && pnpm --filter @examples/basic build`
